 ...
 **/
package com.quartz.monitor.notification;
        ...
        try {
            if ("jobWasExecuted".equalsIgnoreCase(type)) {
                if (object != null && object instanceof CompositeDataSupport) {
                    ...
                    event.setJobName((String) JMXUtil
                            .convertToType(compositeDataSupport, "jobName"));
                    event.setCalendarName((String) JMXUtil.convertToType(
                            compositeDataSupport, "calendarName"));
                    event.setFireTime((Date) JMXUtil
                            .convertToType(compositeDataSupport, "fireTime"));
                    event.setJobGroup((String) JMXUtil
                            .convertToType(compositeDataSupport, "jobGroup"));
                    event.setJobRunTime(
                            ((Long) JMXUtil.convertToType(compositeDataSupport,
                                    "jobRunTime")).longValue());
                    event.setNextFireTime((Date) JMXUtil.convertToType(
                            compositeDataSupport, "nextFireTime"));
                    event.setPreviousFireTime((Date) JMXUtil.convertToType(
                            compositeDataSupport, "previousFireTime"));
                    event.setRecovering(((Boolean) JMXUtil
                            .convertToType(compositeDataSupport, "recovering"))
                                    .booleanValue());
                    event.setRefireCount(((Integer) JMXUtil
                            .convertToType(compositeDataSupport, "refireCount"))
                                    .intValue());
                    event.setScheduledFireTime((Date) JMXUtil.convertToType(
                            compositeDataSupport, "scheduledFireTime"));
                    event.setSchedulerName((String) JMXUtil.convertToType(
                            compositeDataSupport, "schedulerName"));
                    event.setTriggerGroup((String) JMXUtil.convertToType(
                            compositeDataSupport, "triggerGroup"));
                    event.setTriggerName((String) JMXUtil.convertToType(
                            compositeDataSupport, "triggerName"));
                    final String[] arr = getUUID().split("@@");
