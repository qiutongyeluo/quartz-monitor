...
<body scroll="no">
					...
					<div class="accordionContent">
						<ul class="tree treeFolder">
							<li><a href="javascript:void(0)">主框架面板</a>
								<ul>
									<li><a href="quartz/list.action" target="navTab"
										rel="main">我的主页</a></li>
									...
									<li><a href="job/listExecuted.action" target="navTab"
										rel="page3">已执行的任务列表</a></li>
								</ul></li>
				...
				<div class="navTab-panel tabsPageContent layoutBox">
					<div class="page unitBox">
						<div class="accountInfo">
							...
							<p>源自开源项目:quartz monitor + jwatch</p>
						</div>
					</div>
	...
	<div id="footer">Copyright &copy; 2016 好房</div>
</body>
</html>